...
public:
    ...
    //Set multiplier
        ...
        if ((3 < cost && cost <= 5) && (24 < age && age <= 36 )){ multiplier = 1.1; }
        else if ((3 < cost && cost <= 5) && (12 <= age && age <= 24 )){ multiplier = 1.3; }
        else if ((3 < cost && cost <= 5) && (12 > age)){ multiplier = 1.5; }
        //between 5 and 10 millions
        else if (5 < cost && cost <= 10 && age < 60){ multiplier = 2; }
        //between 10 and 15 millions
        else if ((10 < cost && cost <= 15) && age < 120){ multiplier = 3; }
        // more than 15 millions
        else if (cost > 15 && age < 240){ multiplier = 3; }
    //Calculate
